...
$mail->Subject = 'SEO Submission';
//For user mail set the subject line
$mail1->Subject = 'SEO Submission';
...
$html.= '<p> SEO In The Past Y/N: ' .$_POST['pastseo'].'</p>';
...
$html.= '<p> Services: ' .implode("," , $_POST['services']).'</p>';
    ...
    if ($captcha_success->success==false) {
        header('Location: https://www.mogulmatter.com/seo-start.html');
        die;
    } 
...
<p>Thank you for your interest in SEO for ".$_POST['businessname'].".</p>

<p>We will reach out to your shortly</p>
