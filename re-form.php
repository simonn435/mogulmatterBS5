...
$mail->Subject = 'Real Estate Photography & Video';
//For user mail set the subject line
$mail1->Subject = 'Real Estate Photography & Video';
...
$html.= '<p> Phone Number: ' .$_POST['phonenumber'].'</p>';
$html.= '<p> Property Address: ' .$_POST['propertyaddress'].'</p>';
$html.= '<p> Number of Bedrooms: ' .$_POST['bedrooms'].'</p>';
$html.= '<p> Number of Bathrooms\: ' .$_POST['bathrooms'].'</p>';
$html.= '<p> Property Size: ' .$_POST['propertysize'].'</p>';
$html.= '<p> Property Type: ' .$_POST['propertytype'].'</p>';
$html.= '<p> Date: ' .$_POST['date'].'</p>';
$html.= '<p> Time: ' .$_POST['time'].'</p>';
...
$url = 'https://www.google.com/recaptcha/api/siteverify';
    ...
    if ($captcha_success->success==false) {
        header('Location: https://www.mogulmatter.com/re-start.html');
        die;
    } 
...
<p>Thank you for your interest in Real Estate Photography and Video for ".$_POST['propertyaddress'].".</p>

<p>*To get started you must select and purchase one of our services if you have not already.<br>
https://www.mogulmatter.com/re-payment.html </p>
...
header('Location: https://www.mogulmatter.com/re-payment.html');
die;
?>
