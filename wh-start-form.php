...
$mail->Subject = 'Hosting Submission';
//For user mail set the subject line
$mail1->Subject = 'Hosting Submission';
...
$html.= '<p> Estimated Traffic: ' .$_POST['traffic'].'</p>';
$html.= '<p> Estimated Size: ' .$_POST['websize'].'</p>';
...
$url = 'https://www.google.com/recaptcha/api/siteverify';
    ...
    if ($captcha_success->success==false) {
        header('Location: https://www.mogulmatter.com/wh-start.html');
        die;
    } 
...
<p>Thank you for your interest in Real Estate Photography for ".$_POST['businessname'].".</p>
...
header('Location: https://www.mogulmatter.com/wh-payment.html');
die;
?>
